...
export default function Portfolio() {
  return (
    <section id="portfolio" className="relative bg-cream">
      <div className="mx-auto max-w-[1440px] px-6 md:px-12 pt-14 md:pt-20">
        <h2 className="font-display uppercase tracking-tight text-ink leading-[0.9] text-6xl md:text-8xl">
          .Portfolio
        </h2>
      </div>
      <div className="mx-auto max-w-[1440px] px-6 md:px-12 mt-10 md:mt-14 pb-14 md:pb-20">
        <div className="grid grid-cols-2 md:grid-cols-3 gap-2 md:gap-3">
          {PHOTOS.map((p) => (
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-ink via-ink/60 to-transparent opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
