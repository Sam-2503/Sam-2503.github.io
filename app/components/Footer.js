export default function Footer() {
  return (
    <>
      <section data-footer="" data-wf--footer--theme-variant="base" className="footer u-theme-dark">
                <div className="footer_container u-container u-grid-main">
                    <div className="footer_layout">
                        <div className="footer_top u-grid-column-2">
                            <div className="footer_top_left">
                                <nav className="footer_nav">
                                    <ul id="" className="footer_nav_wrap">
                                ...
                                <div className="footer_top_links_mobile">
                            ...
                            </div><a data-anim-link-hover="" href="/playground" className="nav_small_link_item u-text-style-small">Playground</a><a data-anim-link-hover="" href="https://www.linkedin.com/in/playfight/" target="_blank" className="nav_small_link_item u-text-style-small">LinkedIn</a>
                            <a
                    ...
                    <div className="footer_visual_parent">
                        <div className="w-layout-vflex footer_visual_img u-visual-wrap"><video src="https://PlayfightSite.b-cdn.net/Home/PF%20Reel_2026.mp4" autoplay="autoplay" loop="" muted="" webkit-playsInline="" playsInline="" className="g_visual_video"></video></div>
                    </div>
                </div>
                ...
                <div className="footer_bottom_mobile">
                    ...
                    <div className="footer_nl">
                        <div>Subscribe for the latest.</div>
                        <div className="nl_form_main w-form">
                            <form id="wf-form-Newsletter-Form" name="wf-form-Newsletter-Form" data-name="Newsletter Form" method="get" className="form_main_list" data-wf-page-id="697fef4d1b1e73b328ad49be" data-wf-element-id="7a57fa7b-35fd-826c-5350-41fd702f73fb"><label className="nl_form_main_field_wrap"><input className="nl_form_main_field_input w-input" maxLength="256" name="Newsletter-email" data-name="Newsletter email" placeholder="Email" type="email" id="Newsletter-email" required=""/><div className="nl_form_btn"><div className="g_clickable_wrap"><a target="" href="#" className="g_clickable_link w-inline-block"><span className="g_clickable_text u-sr-only">Submit</span></a><button type="submit" className="g_clickable_btn"><span className="g_clickable_text u-sr-only">Submit</span></button></div><svg data-wf--icon-arrow--variant="base" viewBox="0 0 8 13" fill="none" width="100%" height="100%" vector-path="non-scaling-stroke" aria-hidden="true" className="g_svg g_path"><path d="M0.506958 0.552979L6.50696 6.05298L0.506958 11.553" stroke="currentColor" strokeWidth="var(--border-width--main)" vector-effect="non-scaling-stroke"></path></svg></div></label></form>
                            <div
                                className="form_main_success_wrap w-form-done">
                                <div className="form_main_success_text">Thank you! Your submission has been received!</div>
                        </div>
