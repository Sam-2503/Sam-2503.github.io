...
export default function AboutMe() {
  return (
    <section id="about" className="relative bg-cream overflow-hidden">
      <div className="mx-auto max-w-[1440px] px-6 md:px-12 py-14 md:py-20">
        ...
        <div className="mt-10 md:mt-14 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
          <div className="relative flex flex-col min-h-[420px]">
            <p className="max-w-md text-sm md:text-base leading-relaxed">
              Iihilitatem sequunt, cuptas velest, od iditaer umquodion. Cum
              quia voluptatem sequi nesciunt, neque porro quisquam est, qui
          ...
          <div className="bg-ink text-cream p-8 md:p-12 flex items-end min-h-[420px]">
            <p className="max-w-md text-sm md:text-base leading-relaxed">
              Iihilitatem sequunt, cuptas velest, od iditaer umquodion. Cum
              quia voluptatem sequi nesciunt, neque porro quisquam est, qui
              dolorem ipsum quia dolor sit amet, consectetur, adipisci velit,
