...
const LINKS = [
	{
		label: "Instagram",
		icon: FaInstagram,
		href: "https://www.instagram.com/sam25.__/",
	},
	{ label: "GitHub", icon: FaGithub, href: "https://github.com/Sam-2503" },
	{
		label: "LinkedIn",
		icon: FaLinkedin,
		href: "https://www.linkedin.com/in/samprad/",
	},
];
	...
	return (
		<section id="contact">
			<div className="bg-cream">
				<div className="mx-auto max-w-360 px-6 md:px-12 py-16 md:py-24 text-center">
					...
					<p className="mt-10 font-display tracking-normal text-accent">
						<a href="mailto:sampraaddas@gmail.com">
							sampraaddas@gmail.com
						</a>
					</p>
				</div>
			</div>
