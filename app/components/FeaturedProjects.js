export default function FeaturedProjects() {
  return (
    <>
      <section className="featured_project u-theme-dark">
                <div className="featured_project_container u-container">
                    <div className="featured_project_layout">
                        <div data-wf--global-heading--settings-variant="base" className="u-display-contents">
                            <h2 className="g_heading u-mb-6"><strong>Recent work</strong></h2>
                        </div>
                        <div className="featured_project_wrap w-dyn-list">
                            <div role="list" className="featured_project_list u-grid-column-2 w-dyn-items">
                                    ...
                                    <a aria-label="project link" href="/project/adventure-safe" className="featured_project_link w-inline-block">
                                        ...
                                        <div className="w-layout-vflex featured_project_info">
                                            <div data-wf--global-heading--settings-variant="text-large" data-project-hover="" className="u-display-contents">
                                                <h3 className="g_heading w-variant-db6bf09d-2bdf-e648-094e-dbbd73798a2f">Frank &amp; Morris</h3>
                                            </div>
                                            <div data-wf--global-heading--settings-variant="text-small" className="u-display-contents">
                                                <h4 className="g_heading w-variant-6dfc6233-60b2-28e8-f33d-383038b739b5">Adventure Safe</h4>
                                            </div>
                                        </div>
                                ...
                                <div id="w-node-_1ef36d21-cd8e-f8c6-4978-037acd605c2a-28ad49be" role="listitem" className="featured_project_item w-dyn-item">
                                    <a aria-label="project link" href="/project/utah-office-of-tourism-parks-beyond" className="featured_project_link w-inline-block">
                                        ...
                                        <div className="w-layout-vflex featured_project_info">
                                            <div data-wf--global-heading--settings-variant="text-large" data-project-hover="" className="u-display-contents">
                                                <h3 className="g_heading w-variant-db6bf09d-2bdf-e648-094e-dbbd73798a2f">Parks &amp; Beyond</h3>
                                            </div>
                                            <div data-wf--global-heading--settings-variant="text-small" className="u-display-contents">
                                                <h4 className="g_heading w-variant-6dfc6233-60b2-28e8-f33d-383038b739b5">Utah Office of Tourism</h4>
                                            </div>
                                        </div>
                                        <div className="u-embed-css w-embed">
                                            <style dangerouslySetInnerHTML={{ __html: `
                                ...
                                <div id="w-node-_1ef36d21-cd8e-f8c6-4978-037acd605c2a-28ad49be" role="listitem" className="featured_project_item w-dyn-item">
                                    <a aria-label="project link" href="/project/grit-moto---blue-danube" className="featured_project_link w-inline-block">
                                        ...
                                        <div className="w-layout-vflex featured_project_info">
                                            <div data-wf--global-heading--settings-variant="text-large" data-project-hover="" className="u-display-contents">
                                                <h3 className="g_heading w-variant-db6bf09d-2bdf-e648-094e-dbbd73798a2f">Blue Danube</h3>
                                            </div>
                                            <div data-wf--global-heading--settings-variant="text-small" className="u-display-contents">
                                                <h4 className="g_heading w-variant-6dfc6233-60b2-28e8-f33d-383038b739b5">Grit Moto</h4>
                                            </div>
                                        </div>
                                        <div className="u-embed-css w-embed">
                                            <style dangerouslySetInnerHTML={{ __html: `
                                ...
                                <div id="w-node-_1ef36d21-cd8e-f8c6-4978-037acd605c2a-28ad49be" role="listitem" className="featured_project_item w-dyn-item">
                                    <a aria-label="project link" href="/project/wgu---lilly-project" className="featured_project_link w-inline-block">
                                        ...
                                        <div className="w-layout-vflex featured_project_info">
                                            <div data-wf--global-heading--settings-variant="text-large" data-project-hover="" className="u-display-contents">
                                                <h3 className="g_heading w-variant-db6bf09d-2bdf-e648-094e-dbbd73798a2f">Lilly Project</h3>
                                            </div>
                                            <div data-wf--global-heading--settings-variant="text-small" className="u-display-contents">
                                                <h4 className="g_heading w-variant-6dfc6233-60b2-28e8-f33d-383038b739b5">WGU</h4>
                                            </div>
                                        </div>
                                        <div className="u-embed-css w-embed">
                                            <style dangerouslySetInnerHTML={{ __html: `
                                ...
                                <div id="w-node-_1ef36d21-cd8e-f8c6-4978-037acd605c2a-28ad49be" role="listitem" className="featured_project_item w-dyn-item">
                                    <a aria-label="project link" href="/project/utah-office-of-tourism-ski-winter" className="featured_project_link w-inline-block">
                                        ...
                                        <div className="w-layout-vflex featured_project_info">
                                            <div data-wf--global-heading--settings-variant="text-large" data-project-hover="" className="u-display-contents">
                                                <h3 className="g_heading w-variant-db6bf09d-2bdf-e648-094e-dbbd73798a2f">Utah Person (Winter)</h3>
                                            </div>
                                            <div data-wf--global-heading--settings-variant="text-small" className="u-display-contents">
                                                <h4 className="g_heading w-variant-6dfc6233-60b2-28e8-f33d-383038b739b5">Utah Office of Tourism</h4>
                                            </div>
